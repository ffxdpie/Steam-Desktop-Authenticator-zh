...
namespace Steam_Desktop_Authenticator
{
    public class Manifest
    {
        ...
        public static Manifest GenerateNewManifest(bool scanDir = false)
        {
            ...
            if (scanDir)
            {
                ...
                if (Directory.Exists(maDir))
                {
                    ...
                    {
                        newManifest.Save();
                        newManifest.PromptSetupPassKey("此版本的 SDA 具有加密功能。 请在下面输入密码，或点击“取消”以保持未加密状态");
                    }
                }
            }
        ...
        public string PromptSetupPassKey(string initialPrompt = "输入密码，或点击“取消”以保持未加密状态.")
        {
            ...
            {
                MessageBox.Show("警告：您选择不加密您的文件。 这样做会给您自己带来安全风险。 如果攻击者要访问您的计算机，他们可能会完全将您锁定在您的帐户之外并窃取您的所有物品.");
                return null;
            }

            InputForm newPassKeyForm2 = new InputForm("确认新的密钥。");
